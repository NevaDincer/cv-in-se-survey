...
- **eval_method:** 65.85% replay accuracy on Android (+8.74%), 35.26% on iOS (+35%) over state-of-the-art
- **challenges:** same app has structurally similar but platform-divergent UI layouts across Android, iOS, and mini-programs
